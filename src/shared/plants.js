export const PLANTS = [
  ...
  },
  {
    ...
    shortDescription:
      "Our 10-inch and 12-inch flower baskets are of unbeatable quality. They regularly sell out every year.",
    data: [
    {
      id: 15,
      name: "Combo Basket",
  ...
  },
  {
    ...
    shortDescription:
      "Choose from a selection of popular herbs and tomatoes avaialable in 4-inch pots.",
    data: [
    {
      id: 24,
      name: "Better Boy",
  ...
  },
  {
    ...
    shortDescription:
      "Flowering annuals and accent plants available in a variety of pot sizes.",
    data: [
    {
      id: 37,
